...
<!-- Start up the actual body stuff cause OH MY GOD ALL THIS CODE -->
    <section id="header">
        <div id="header_navigation">
            <span class="company_logo">
                 <a href="index.html" title="Mechanical Associates"><img src="PictureRefs/MechanicalAssociates_Logo1.png" height="70px";></img></a>
            </span>
            <span class="links">
    ...
    <section id="main_content">
        ...
        <div id="content" style="position: relative; height: 450px;">
            <h1>Contact Us</h1>
            <hr>
            <div style="float: right; text-align: left; position: relative; margin: auto; padding-right: 115px; border-left: 100px; padding-top: 50px;">
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="PictureRefs/MA-Logo-Full_Color.png" style="width: 300px;"></img><p>
          ...
          <div id="ContactForm">
            <form action="<?php $PHP_SELF ?>" name="feedbackForm" method="post" id="feedbackForm" style="float: left; padding-left: 45px; margin: auto; padding-right: 175px; border-right: 2px solid #0E7DC2;">
              ...
              <input type="text" size="10" name="full_name" value="<?php echo $_POST["full_name"]; ?>" ></input>
                <?php if(isset($errFullName)) echo $errFullName; ?><p>

              <label for="email_address">*Email Address:</label><br/>
              <input type="text" size="10" name="email_address" value="<?php echo $_POST["email"]; ?>"></input>
                <?php if(isset($errEmail)) echo$errEmail; ?><p>
              ...
              <textarea name="comments" rows="5" cols="50" name="feedback_area"><?php echo $_POST["comments"]; ?></textarea>
                <?php if(isset($errFeedback)) echo $errMessage; ?><p>

              <input type="submit" value="Submit" name="submit"></input><p></p>

            </form>
          </div>

        </div>
        <div id="content_mini" style="position: relative; height: 50px;">
            <p>
              <b>Or contact your local representative!</b>
            </p>
        </div>
         <div style="width: 70%; background-color: rgba(5, 23, 41, 0.7); border-radius: 10px; position: relative; padding-top: 10px; padding-left: 45px; padding-right: 45px; padding-bottom: 5px; margin: auto;">
            ...
            <div id="social_media">
             ...
             <div id="Logo_Only">
                <div class="Logo" style="text-align: right; padding-right: 25px;">
                    <img src="PictureRefs/LOGOONLY.png" width="85"; height="50";></img><br/>
                </div>
            </div>
